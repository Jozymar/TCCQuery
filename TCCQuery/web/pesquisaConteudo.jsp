...
<html>
    <head>
        ...
        <title>Pesquisar Por Conteúdo</title>
            ...
            <div id="divContPes">
                <div class="row">
                    <div class=" col-md-12 text-center">
                        <h1>Pesquisar Por Conteúdo</h1>
                    </div>
                </div>
                <div id="divPesLocal">
                    <form action="pesquisaConteudo.jsp" method="post" name="pesquisarConteudo">   
                        <div class="input-group input-group">
                            <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-calendar"></i></span>
                            <input type="text" name="nome" class="form-control" placeholder="Buscar Por Conteúdo" aria-describedby="basic-addon1" required>
                            <div class="input-group-btn">
                                <input type="hidden" name="identificador" value="PesquisarConteudo"> 
                ...
                <div class="form-group">
                    <div class="col-md-12 text-center" id="divResultado">
                        <h4>Não encontramos nenhum tcc para este conteúdo :(</h4>
                    </div>
                </div>
