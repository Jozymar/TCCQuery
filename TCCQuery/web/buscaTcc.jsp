        ...
        <div class="container-fluid">
            <div id="divContPes">
                ...
                <div id="divPesLocal">
                    <form action="FrontControl" method="post" >   
                        <div class="input-group input-group">
                            ...
                            <input type="text" name="query" class="form-control" placeholder="Busque por Título, Resumo, Palavras-Chave ou Conteúdo" aria-describedby="basic-addon1" required>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:if test="${not empty param.buscarTcc}">
