        ...
        <div class="container-fluid">
            <div id="divContPes">
                    ...
                    <form action="FrontControl" method="post" >   
                        <div class="input-group input-group">
                            ...
                            <div class="input-group-btn">
                                ...
                                <button class="btn btn-primary btn-md btn-block" role="button" name="buscaTccPorAno" type="submit">
                ...
                <c:choose>
                    ...
                    <c:when test="${empty tccs and param.buscaTccPorAno != null}">          
