        ...
        <div class="container-fluid">
            <div class="row contant">
                    ...
                    <div class="col-sm-4 col-sm-push-4 sidenav text-center" id="divMenu">
                        ...
                        <a name="pesquisarTcc" href="pesquisaTcc.jsp" class="btn btn-primary btn-md btn-block" role="button"><span id="btPerfil" class="glyphicon glyphicon-search"></span> Pesquisar TCC</a>
